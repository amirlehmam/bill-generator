                    ...
                    {invoice.items.map((item, index) => {
                      ...
                      return (
                        <tr key={index} className="border-b">
                          <td className="py-2 px-2 border-r text-sm text-gray-900 text-center align-middle">
                            {item.description}
                          </td>
                          <td className="py-2 px-2 border-r text-sm text-gray-900 text-center align-middle">
                            {item.quantity}
                          ...
                          <td className="py-2 px-2 border-r text-sm text-gray-900 text-center align-middle font-medium">
                            {formatCurrency(totalTTC)}
                          </td>
                          <td className="py-2 px-2 border-r text-center align-middle">
